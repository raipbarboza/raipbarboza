...
- **Python for Data Analysis** — variables, data structures, loops and conditionals
- **Web Scraping** — collecting ESG reports and sustainability data from public sources
- **Git & GitHub** — version control and building a public portfolio
